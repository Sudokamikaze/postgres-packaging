...
get_sources(){
    ...
    cd debian
    rm -f rules
    wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/patroni/rules
    rm -f control
    rm -f postinst
    wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/patroni/control
    ...
    cd rpm
    rm -f patroni.spec
    wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/patroni/patroni.spec
