...
get_sources(){
    ...
    wget     wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/pgbackrest/control.patch
    ...
    mkdir rpm
    cd rpm
    wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/pgbackrest/pgbackrest.spec
    wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/pgbackrest/pgbackrest.conf
    cd ${WORKDIR}
    #
