...
get_sources(){
	...
	rm -f control rules
        wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/postgres/control
        wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/postgres/rules
    ...
    cd rpm
        ...
        wget https://raw.githubusercontent.com/Sudokamikaze/postgres-packaging/DISTPG-175/postgres/percona-postgresql-11.spec
    cd ../
    cd ${WORKDIR}
    #
